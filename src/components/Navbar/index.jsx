...
export default function Navbar() {
  ...
  return (
    <nav>
      {/* Desktop Navbar */}
      <div className="hidden md:flex fixed w-full items-center justify-center z-[999] top-[28px] max-w-[1820px] mx-auto">
        <div className="flex flex-row justify-between items-center px-8 py-4 rounded-full w-full mx-5 lg:mx-28 bg-white/60 transition-all duration-300 shadow-md bg-opacity-10 backdrop-blur-2xl hover:bg-opacity-100">
          <div className="flex justify-between items-center rounded-full w-full">
            ...
            <button className="capitalize rounded-full text-white py-2 px-2 lg:px-6 bg-[#221D80] flex items-center gap-2 hover:bg-[#1a1560] transition-colors cursor-pointer">
